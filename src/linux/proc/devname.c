 ...
 * Copyright (C) 1996 Charles Blake, see ../COPYING.LIB for distribution
 * conditions.
...
/*
 * This __KERNEL__ stuff worked through kernel 2.4,
 * but breaks kernel 2.6 on Debian as of 17-Dec-04 => removed.

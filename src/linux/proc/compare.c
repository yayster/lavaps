/*
 *
 * Copyright 1994-1998 Charles Blake and Michael K. Johnson
 * This file is distributable under the conditions of the
 * GNU Library General Public License.  See the
